...
def generate_and_verify(bits, generator, verifier, precision = 10):
    begin = time.time()
    m = pow(2, bits)
    result = pow(int(begin), bits, m-1)#pow(7, bits, m) #generates a seed about the size of m
...
"""Solovay-Strassen primlity test
...
if __name__ == "__main__":
    ...
    for i in range(3):
        ...
        number = xorshift_generator(number, m)
    ...
    print("Primes:")
    print(string)
    print("Average time elapsed(s): " + str(total_time/3))
